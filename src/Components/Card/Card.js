...
// This functional component represents a single card in the Kanban board
export default function Card(props) {
  return (
    <>
        <div className="card-container">
            {/* Wrapper for card ID and user profile */}
            <div className="card-id-wrapper">
                ...
                <div className="card-profile">
                    ...
                    {/* Conditional class for user availability */}
            ...
            <div className="card-tag">
                {
                    // Mapping priority to corresponding SVG icons
                    {
                ...
                {/* Mapping through tags to display each tag */}
                {
                    props.cardDetails.tag.map((tag) => {
                        return(
                            <div className="card-tag-box" key={tag}>
